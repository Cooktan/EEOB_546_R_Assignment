...
#line 217-219 gave an odd output for the chart. The first chart just had a single dot in the middle. The second is all nunched up on one side and hard to read. Even when I zoom into the image it is still stacked on each other or something. The last chart did the same thing for me. 
